...
public class RenderBityardFishHook extends Render<EntityBityardFishHook> {

    private static final ResourceLocation FISH_PARTICLES = new ResourceLocation("minecraft:textures/particle/particles.png");

    public RenderBityardFishHook(RenderManager renderManagerIn)
    {
     ...
     */
    public void doRender(EntityBityardFishHook entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entityplayer != null && !this.renderOutlines)
        {
            ...
            if (itemstack.getItem() != BityardItems.FISHING_ROD)
            {
                k = -k;
            }
     ...
     */
    protected ResourceLocation getEntityTexture(EntityBityardFishHook entity)
    {
